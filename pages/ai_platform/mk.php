    ...
    <section class="mk-graph">
        <div class="container-xl">
            ...
            <article class="no-article">
                <ul class="graph-list">
                    <li <?= $aos_slow ?>>
                        <img src="<?=IMG_PATH?>/new/mb_new_img_1.svg" alt="">
                        <h3>경기도 광명시</h3>
                    </li>

                    <li <?= $aos_slow ?>>
                        <img src="<?=IMG_PATH?>/new/mb_new_img_2.svg" alt="">
                        <h3>한국벤처투자</h3>
                    </li>

                    <li <?= $aos_slow ?>>
                        <img src="<?=IMG_PATH?>/new/mb_new_img_3.svg" alt="">
                        <h3>농림축산식품부</h3>
                    </li>

                    <li <?= $aos_slow ?>>
                        <img src="<?=IMG_PATH?>/new/mb_new_img_4.svg" alt="">
                        <h3>코이카</h3>
                    </li>
                </ul>
            </article>
