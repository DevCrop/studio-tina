...
<main class="sub-hub">
 ...
 <h2 style=" position: absolute;
    ...
    <section class="hub-headline">
        <figure class="back-bg" style="background-image: url('/resource/images/percent-bg.jpg');">
        </figure>
        <div class="container-xl">
            <hgroup class="reveal">
                <span class="letter">
                    <h2>복잡한 영상 제작 AI로 쉽고 간편하게</h2>
                    <p>긴 영상 제작 과정은 이제 잊으세요! AI가 빠르고 간편하게<br> 당신의 아이디어를 고퀄리티 영상으로 완성합니다.
                    </p>
                </span>
            </hgroup>
            <img src="/resource/images/ai-mockup.png" <?= $aos_slow_delay ?>>
        </div>
    </section>
                ...
                <ul class="effect-list">
                    <li>
                        <div class="txt">
                            ...
                            <p>주제만 입력하면 AI가 스토리보드부터 완성된 영상까지 빠르고 간편하게 제작해 드립니다.</p>
                        </div>
                    ...
                    <li>
                        <div class="txt">
                            ...
                            <p>템플릿과 AI 자동화로 제작 비용을 최소화하며, 전문가 없이도 고퀄리티 영상을 완성할 수 있습니다.</p>
                        </div>
                    ...
                    <li>
                        <div class="txt">
                            ...
                            <p>다양한 스타일과 언어를 지원해 글로벌 시장에 적합한 맞춤형 콘텐츠를 손쉽게 제작할 수 있습니다.</p>
                        </div>
        ...
        <div class="container-xl">
            ...
            <article class="no-article">
                <ul class="function-list">
                    <li <?= $aos_slow ?>>
                        <figure>
                            <img src="/resource/images/ai-function1.png">
                        </figure>

                        <div class="txt">
                            <h3>원클릭 비디오 제작</h3>
                            <p>0에서 시작하는 영상 만들기, 간단한 주제 또는 이미지를 입력하면<br> AI가 스토리보드 제작, 영상 제작까지 한 번에 완료해 줍니다.
                            </p>
                        </div>
                    ...
                    <li <?= $aos_slow ?>>
                        <figure>
                            <img src="/resource/images/ai-function2.png">
                        </figure>
                    ...
                    <li <?= $aos_slow ?>>
                        <figure>
                            <img src="/resource/images/ai-function3.png">
                        </figure>

                        <div class="txt">
                            <h3>템플릿 기반 제작 (Magic Create)

                            </h3>
                            <p>제공된 템플릿을 활용해 누구나 손쉽게 원하는 영상을 제작할 수 있습니다.<br>
부동산, 마케팅, 이벤트 홍보 등 다양한 산업과 목적에 최적화된 템플릿으로 시간을 절약하세요.</p>
                    ...
                    <li <?= $aos_slow ?>>
                        <figure>
                            <img src="/resource/images/ai-function4.png">
                        </figure>
                        ...
                        <div class="txt">
                            ...
                            <p>장면 추가부터 자막 수정, 영상 스타일, 배경음악까지 자유롭게 편집하며<br> 원하는 방향으로 영상을 완성할 수 있습니다.
                            </p>
                        </div>
                    </li>
                </ul>
