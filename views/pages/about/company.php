...
<section class="no-sub-about-company no-section-md">
    <div class="no-container-2xl">
        <div class="no-sub-section-title --tac">
            <h2 class="f-display-2 fade-up">Who We Are</h2>
            <p class="f-heading-4 --medium fade-up">
                스튜디오 티나는 AI 기술을 활용해<br>
                드라마·영화·숏폼 등 영상 콘텐츠를 기획·제작하는<br>
                AI 크리에이티브 스튜디오입니다.
            </p>
            <span class="f-body-1 --regular fade-up">
        ...
        <li class="no-sub-about-snap-item" data-direction="left">
            <div class="no-sub-about-snap-item-wrap">
                ...
                <div class="no-sub-about-snap-item-inner">
                    <figure>
                        <img src="/resource/images/sub/sub_snap_img_<?= $i ?>.jpg" alt="">
                    </figure>
                </div>
                <?php endfor; ?>
            </div>
...
<section class="no-sub-about-doing no-section-md">
    <div class="no-container-2xl">
        <div class="no-sub-section-title --tac">
            <h2 class="f-display-2 fade-up">What We Do</h2>
            <p class="f-heading-4 --medium fade-up">
        ...
        <div class="no-sub-about-rotate-inner">
            ...
            <div class="no-sub-about-rotate-circle ">
                ...
                <div class="border-circle">
                    ...
                    <div class="bg-circle">
                        <div class="list">
                            <div class="no-sub-about-rotate-circle-text">
                                <div class="f-heading-2 circle-text-item current">
                                    <h3 class=" ">AI <br>
                                        Creative Production</h3>
                                    <p class="f-body-1">AI 기반 풀파이프라인으로 효율적이고 완성도 높은 영상 제작</p>
                                </div>
                                <div class="f-heading-2 circle-text-item">
                                    <h3>VFX <br>
                                        AI
                                        Solutions</h3>
                                    <p class="f-body-1">AI·VFX 기술로 비용과 시간을 줄이고 글로벌 수준의 비주얼 구현</p>
                                </div>
                                <div class="f-heading-2 circle-text-item">
                                    <h3>Content Planning
                                        <br> Storytelling
                                    </h3>
                                    <p class="f-body-1">IP 기반 기획력과 스토리텔링으로 차별화된 콘텐츠 제작</p>
                                </div>
                                <div class="f-heading-2 circle-text-item">
                                    <h3>Original Content
                                        <br> Film Production
                                    </h3>
                                    <p class="f-body-1">영화·드라마·예능·숏폼 등 다양한 오리지널 콘텐츠 제작</p>
                                </div>
                            </div>
...
<section class="no-sub-about-creators no-section-md">
    <div class="no-container-2xl">
        <div class="no-sub-section-title --tac">
            <h2 class="f-display-2 fade-up">Our Creators</h2>
        </div>
        <div class="--cnt">
            <div class="no-sub-about-creators-inner">
                <?php if (!empty($creatorsByCategory)): ?>
                <?php foreach ($creatorsByCategory as $categoryData): ?>
                <div class="no-sub-about-creators-wrap">
                    <!-- 타이틀 FIXED -->
                    <div class="no-sub-about-creators-title">
                        <h3 class="f-heading-1 --bold fade-up">
                            <?= htmlspecialchars($categoryData['category_name']) ?></h3>
                    </div>
                    <!-- 컨텐츠 일반 스크롤링 -->
                    <div class="no-sub-about-creators-contents">
                        <ul class="fade-up">
                            <?php foreach ($categoryData['creators'] as $creator): ?>
                            <li>
                                ...
                                <?php 
                                    ...
                                    $cleanHtml = trim(strip_tags($rawHtml));
                                ?>
                                <?php if (!empty($cleanHtml)): ?>
                                <div class="no-sub-about-creators-contents-html" data-lenis-prevent>
                                    <?= $rawHtml ?>
                                </div>
                                <?php endif; ?>
                            </li>
