...
(149, 'STTINA', 25, -1, 0, 0, 'SDASDA', '<div><p>SADSDA</p></div>', '2025-10-13 07:26:38', 0, '', 'N', 'N', 'N', NULL, '관리자', 'N', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'N', 'ADSDAS', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 1);
...
--
ALTER TABLE `nb_board`
  MODIFY `no` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;
